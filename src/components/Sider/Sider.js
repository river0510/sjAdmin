...
export default class Sider extends React.Component {
	...
	render() {
		return (
	        ...
	        className="sider"
	      >
	        <SubMenu key="sub1" title={<span><Icon type="mail" /><span>部门概况</span></span>}>
	          <Menu.Item key="1"><Link to='/addArticle'>部门概况</Link></Menu.Item>
	        </SubMenu>
	        <SubMenu key="sub2" title={<span><Icon type="appstore" /><span>通知公告</span></span>}>
	          <Menu.Item key="2"><Link to='/addArticle'>通知公告</Link></Menu.Item>
	        </SubMenu>
	        <SubMenu key="sub3" title={<span><Icon type="setting" /><span>工作动态</span></span>}>
	          <Menu.Item key="3">财务审计</Menu.Item>
	          <Menu.Item key="4">工程审计</Menu.Item>
	          <Menu.Item key="5">学习交流</Menu.Item>
	        </SubMenu>
			<SubMenu key="sub4" title={<span><Icon type="mail" /><span>政策法规</span></span>}>
	          <Menu.Item key="6">政策法规</Menu.Item>
	        </SubMenu>
			<SubMenu key="sub5" title={<span><Icon type="mail" /><span>资料下载</span></span>}>
	          <Menu.Item key="7"><Link to='/addArticle'>上级文件</Link></Menu.Item>
	          <Menu.Item key="8">校内制度</Menu.Item>
	          <Menu.Item key="9">校内文件</Menu.Item>
	        </SubMenu>
			<SubMenu key="sub6" title={<span><Icon type="mail" /><span>首页顶部</span></span>}>
	          <Menu.Item key="10">顶部链接</Menu.Item>
	        </SubMenu>
			<SubMenu key="sub7" title={<span><Icon type="mail" /><span>首页底部</span></span>}>
			...
			<SubMenu key="sub8" title={<span><Icon type="mail" /><span>轮播图</span></span>}>
